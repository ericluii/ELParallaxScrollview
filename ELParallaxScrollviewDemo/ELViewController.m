...
- (void)setupTitles {
    ...
    [_psv addSubview:title withEndPoint:CGPointMake(0, 250.0f)
                      andAnimationStart:0.0f
                        andAnimationEnd:100.0f];
    ...
    [_psv addSubview:name withEndPoint:CGPointMake(0, -10.0f)
                     andAnimationStart:0.0f
                       andAnimationEnd:80.0f];
}
...
- (void)setupTriforce {
    ...
    [_psv addSubview:scroll withEndPoint:CGPointMake(-130.0f, 600.0f)
                       andAnimationStart:0.0f
                         andAnimationEnd:140.0f];
    ...
    [_psv addSubview:up withEndPoint:CGPointMake(450.0f, 100.0f)
                   andAnimationStart:0.0f
                     andAnimationEnd:140.0f];
    ...
    [_psv addSubview:top withEndPoint:CGPointMake(130.0f, 400.0f)
                    andAnimationStart:0.0f
                      andAnimationEnd:120.0f];
    ...
    [_psv addSubview:left withEndPoint:CGPointMake(101.0f, 450.0f)
                     andAnimationStart:40.0f
                       andAnimationEnd:120.0f];
    ...
    [_psv addSubview:right withEndPoint:CGPointMake(159.0f, 450.0f)
                      andAnimationStart:40.0f
                        andAnimationEnd:140.0f];
}
...
- (void)setupCreate {
    ...
    [_psv addSubview:bg withEndPoint:CGPointMake(0, 525.0f)
                   andAnimationStart:100.0f
                     andAnimationEnd:250.0f];
    ...
    [_psv addSubview:easy withEndPoint:CGPointMake(0, 450.0f)
                     andAnimationStart:150.0f
                       andAnimationEnd:600.0f];
    ...
    [_psv addSubview:more withEndPoint:CGPointMake(0, 600.0f)
                     andAnimationStart:150.0f
                       andAnimationEnd:700.0f];
    ...
    [_psv addSubview:wow withEndPoint:CGPointMake(0, 850.0f)
                    andAnimationStart:300.0f
                      andAnimationEnd:1100.0f];
    ...
    [_psv addSubview:mountain withEndPoint:CGPointMake(0, 1175.0f)
                         andAnimationStart:400.0f
                           andAnimationEnd:1050.0f];
}
...
-(void)setupGit {
    ...
    [_psv addSubview:bg withEndPoint:CGPointMake(0, 1500.0f)
                   andAnimationStart:700.0f
                     andAnimationEnd:1000.0f];
}
